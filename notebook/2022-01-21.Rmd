...
**Count number of function calls in a .R file**.

```{r}
#| eval: false
code <- parse("functions.R")
getParseData(code)
# ... do some data analysis on this this data.frame()
```
...
### How to get manual spline predictions from GAMLSS
