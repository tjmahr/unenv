<!--- Timestamp to trigger book rebuilds: 2024-01-24 14:13:05.33964 --->
...
Check this out. `as.dist()` will clean up the redundant output, but it discards the diagonal. [Suggestion from StackOverflow](https://stackoverflow.com/questions/2535234/find-cosine-similarity-between-two-arrays).
...
Still, two points could be very different distances from the origin, but they
could have an angle of 0.
