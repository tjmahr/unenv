<!--- Timestamp to trigger book rebuilds: 2025-08-06 14:09:06.606852 --->
...
participant's conditional or subject-specific parameter values (a.k.a.,
BLUPs):
...
#>     else 0
#> }
#> <environment: 0x0000025cd2067880>
```
...
#>  - attr(*, "srcfile")=Classes 'srcfilecopy', 'srcfile' <environment: 0x0000025cdf9224e0>

my_func |> attr("srcref") |> attr("srcfile") |> str()
#> Classes 'srcfilecopy', 'srcfile' <environment: 0x0000025cdf9224e0>
```
