<!--- Timestamp to trigger book rebuilds: 2025-07-08 15:07:07.989742 --->
...
<figure>
  <img src="assets/figure/2025-07-08/sim1-1.png" style="margin-left: auto; margin-right: auto; display: block;"/>
...
#> Unit: milliseconds
#>                                                     expr      min       lq
#>  m$functions$logitnormal_mean2(mu = mus, sigma = sigmas) 116.0432 116.1764
#>                 wisclabmisc::logitnorm_mean(mus, sigmas) 909.9525 921.1872
#>      mean   median       uq       max neval
#>  118.0503 116.5713 117.4801  131.0881    20
#>  935.6726 925.6789 936.5421 1015.0339    20
```
